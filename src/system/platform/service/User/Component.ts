...
import { ANIMATION_T_S, linearTransition } from '../../../../client/animation'
...
import IOButton from '../../component/core/IOButton/Component'
...
export default class User extends Component<HTMLDivElement, Props> {
  ...
  private _username: TextDiv
  private _picture: Div
  private _email: TextDiv
  private _signout: IOButton

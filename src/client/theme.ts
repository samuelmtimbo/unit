...
// export const RED = 'hsla(0, 100%, 70%, 1)'
export const RED = '#ff6666'
export const LINK_RED = 'hsla(0, 100%, 65%, 1)'
export const OPAQUE_RED = 'hsla(0, 100%, 50%, 1)'

// export const GREEN = 'hsla(124, 85%, 35%, 1)'
export const GREEN = '#00aa11'

export const LINK_GREEN = 'hsla(124, 85%, 30%, 1)'
export const OPAQUE_GREEN = 'rgba(58, 195, 70, 0.24)'

// export const BLUE = 'hsla(216, 75%, 50%, 1)'
export const BLUE = '#0066ff'
export const LINK_BLUE = 'hsla(216, 75%, 45%, 1)'
...
export const DISABLED = 'rgb(200, 200, 200)'

...
export function isSpecVisible(id: string): boolean {
...
export default class Search extends Element<HTMLDivElement, Props> {
  ...
  constructor($props: Props) {
    ...
    const visible_id_list = id_list.filter(isSpecVisible)

    const ordered_id_list = visible_id_list.sort((a, b) => {
      return compareByComplexity(globalThis.__specs, a, b)
    })

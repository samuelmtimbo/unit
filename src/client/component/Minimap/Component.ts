...
import namespaceURI from '../namespaceURI'
...
export default class Minimap extends Element<HTMLDivElement, Props> {
  ...
  constructor($props: Props) {
    ...
    const map_graph = new SVGG({ className: 'minimap-graph' })
    this._map_graph = map_graph

    // TODO bring "minimap screen" to minimap
    const map_children = new SVGG({ className: 'minimap-children' })

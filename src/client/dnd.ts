...
export function dragAndDrop(
  ...
  $system.flag.dragAndDrop[pointerId] = data
  ...
  $system.flag.pointerCapture[pointerId] = $root
  ...
  const cancel = () => {
    ...
    delete $system.flag.pointerCapture[pointerId]
  ...
  const pointerUpListener = (event: PointerEvent) => {
    ...
    if (_pointerId === pointerId) {
      ...
      delete $system.flag.dragAndDrop[pointerId]
    }
  }

...
export function lazyFromSpec<I, O>(
  ...
  class Lazy<I, O> extends Unit implements G, C {
    ...
    memAddMerge(
      ...
      this._ensure()
      return this._graph.memAddMerge(mergeId, mergeSpec, merge)
    }

    getMergeSpec(mergeId: string): GraphMergeSpec {
      this._ensure()
      return this._graph.getMergeSpec(mergeId)
    }

    memRemoveUnit(unitId: string): void {
      this._ensure()
      return this._graph.memRemoveUnit(unitId)
    }

    memRemoveMerge(mergeId: string): void {
      this._ensure()
      return this._graph.memRemoveMerge(mergeId)
    }
    ...
    appendParentRoot(
      ...
      this._ensure()
      return this._graph.appendParentRoot(subComponentId, childId, slotName)
    }
    ...
    appendParentRootChildren(
      ...
      this._ensure()
      return this._graph.appendParentRootChildren(
        subComponentId,
        children,
        slotMap
      )
    ...
    appendParentChild(component: C<any, any>, slotName: string): void {
      this._ensure()
      return this._graph.appendParentChild(component, slotName)
    }

    removeParentChild(component: C<any, any>): void {
      this._ensure()
      return this._graph.removeParentChild(component)
    }

    appendRoot(subComponentId: any): void {
      this._ensure()
      return this._graph.appendRoot(subComponentId)
    }

    removeRoot(subComponentId: string): void {
      this._ensure()
      return this._graph.removeRoot(subComponentId)
    }
    ...
    moveSubgraphInto(
      ...
      this._ensure()
      return this._graph.moveSubgraphInto(
        graphId,
        nodeIds,
        nextIdMap,
        nextPinMap,
    ...
    registerRoot(component: C<any, any>): void {
      this._ensure()
      return this._graph.registerRoot(component)
    }

    unregisterRoot(component: C<any, any>): void {
      this._ensure()
      return this._graph.unregisterRoot(component)
    }

    registerParentRoot(component: C<any, any>, slotName: string): void {
      this._ensure()
      return this._graph.registerParentRoot(component, slotName)
    }

    unregisterParentRoot(component: C<any, any>): void {
      this._ensure()
      return this._graph.unregisterParentRoot(component)
    }
    ...
    public refChild(at: number): C<any, any> {
      this._ensure()
      return this._graph.refChild(at)
    }

    public refChildren(): C[] {
      this._ensure()
      return this._graph.refChildren()
    }

    public refSlot(slotName: string): C<any, any> {
      this._ensure()
      return this._graph.refSlot(slotName)
    }
    ...
    public exposePinSet = (
      ...
      this._ensure()
      return this._graph.exposePinSet(type, pinId, pinSpec)
    }
    ...
    memAddUnit(
      ...
      this._ensure()
      return this._graph.memAddUnit(unitId, unitSpec, unit)
    }

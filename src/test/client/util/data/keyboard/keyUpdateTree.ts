...
assert.deepEqual(keyUpdateTree('{:1}', [0, 0], '', 'Backspace', 0, 0, false), [
  true,
  {
    nextRoot: '{1}',
    nextPath: [0],
...
assert.deepEqual(
  keyUpdateTree('{,abc:123}', [0], '', 'Backspace', 0, 0, false),
  [
    true,
    {
      nextRoot: '{abc:123}',
...
assert.deepEqual(keyUpdateTree('[[],]', [1], '', 'ArrowLeft', 0, 0, false), [
  true,
  {
    nextRoot: '[[]]',
    nextPath: [0, 0],

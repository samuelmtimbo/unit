...
assert(isExternalNodeId('%/input/abcdef/0'))
assert(isExternalNodeId('%/output/abcdef/0'))
assert(isExternalNodeId('%/output/[a]/0'))
assert(isExternalNodeId('%/output/a/0'))
assert(isExternalNodeId('%/input/pjcmihkdo/0'))

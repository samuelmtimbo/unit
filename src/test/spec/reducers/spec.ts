...
assert.deepEqual(
  {
    name: 'if else',
    units: {
      if0: { path: 'system/f/control/If' },
      if1: { path: 'system/f/control/If' },
    },
    merges: {
...
assert.deepEqual(
  {
    name: 'if else',
    units: {
      if0: { path: 'system/f/control/If', metadata: { rename: 'if true' } },
      if1: { path: 'system/f/control/If' },
      not: { path: 'system/f/logic/Not' },
    },
    merges: {
...
assert.deepEqual(
  {
    name: 'if else',
    units: {
      if0: { path: 'system/f/control/If', input: { a: { data: 1 } } },
      if1: { path: 'system/f/control/If' },
      not: { path: 'system/f/logic/Not' },
    },
    merges: {
...
assert.deepEqual(
  {
    name: 'if else',
    units: {
      if0: { path: 'system/f/control/If', input: { a: {} } },
      if1: { path: 'system/f/control/If' },
      not: { path: 'system/f/logic/Not' },
    },
    merges: {
...
assert.deepEqual(
  {
    name: 'if else',
    units: {
      if0: { path: 'system/f/control/If', input: { a: { constant: true } } },
      if1: { path: 'system/f/control/If' },
      not: { path: 'system/f/logic/Not' },
    },
    merges: {
...
assert.deepEqual(
  {
    name: 'if else',
    units: {
      if0: { path: 'system/f/control/If', output: { a: { ignored: true } } },
      if1: { path: 'system/f/control/If' },
      not: { path: 'system/f/logic/Not' },
    },
    merges: {
...
assert.deepEqual(
  {
    name: 'if a ≤ b',
    units: {
      lessthanequal: { path: 'system/f/comparisson/LessThanEqual' },
      greaterthan: { path: 'system/f/comparisson/GreaterThan' },
      if0: { path: 'system/f/control/If' },
      if1: { path: 'system/f/control/If' },
    },
    merges: {
...
assert.deepEqual(
  {
    name: 'range',
    units: {
      lte: { path: 'system/f/comparisson/LessThan' },
      increment: { path: 'core/common/Increment' },
      if0: { path: 'system/f/control/If' },
      if1: { path: 'system/f/control/If' },
      id0: { path: 'system/f/control/Identity' },
    },
    merges: {
      merge0: {

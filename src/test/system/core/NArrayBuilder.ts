...
const NArrayBuilder = fromSpec(spec, globalThis.__specs)

// import ArrayBuilder from '../../../unit/system/core/common/NArrayBuilder/Class'

const nArrayBuilder = new NArrayBuilder()
